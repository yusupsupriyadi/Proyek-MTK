...
<h1 class="pb-3 font-bold text-2xl">Menentukan Garis singgung lingkaran yang melalui titik P(x1, y1) pada lingkaran x2 + y2 = r2 pada titik O(0,0)</h1>
  <div class="form-row">
  </div>
  ...
  <div class="form-row">
    <div class="form-group col-md-2">
      <input type="number" class="form-control border-black border-2 border-b-4 rounded-lg" id="inputCity" name="x1" placeholder="x1">
    </div>
    <div class="form-group col-md-0">
      <h4 class="font-bold"> + </h4>
    </div>
    <div class="form-group col-md-2">
      <input type="number" class="form-control border-black border-2 border-b-4 rounded-lg" id="inputCity" name="y1" placeholder="y1">
    </div>
    <div class="form-group col-md-0">
      <h4 class="font-bold"> = </h4>
    </div>
