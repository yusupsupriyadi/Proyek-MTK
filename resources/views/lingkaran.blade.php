...
<html lang="en">
  ...
  <div class="container-fluid">
    <a class="navbar-brand font-bold text-black" href="/">KELOMPOK-X LINGKARAN</a>
</nav>
...
<h1 class="pb-3 font-bold text-lg">Garis Singgung Lingkaran</h1>
  ...
  <div class="form-row">
    <div class="form-group col-md-2">
      <input type="number" class="form-control border-black border-2 border-b-4 rounded-lg" id="inputCity" name="x2" placeholder="x2..">
    </div>
    <div class="form-group col-md-0">
      <h4 class="font-bold"> + </h4>
    </div>
    <div class="form-group col-md-2">
      <input type="number" class="form-control border-black border-2 border-b-4 rounded-lg" id="inputCity" name="y2" placeholder="y2..">
    </div>
    <div class="form-group col-md-0">
      <h4 class="font-bold"> = </h4>
    </div>
...
<div class="pt-3">
  <div class="md-3">
    @if(session('info'))
      <div class="alert alert-info border-black border-2 border-b-8">
        {{ session('info')}}
      </div>
    @endif
  </div>
  ...
  <div class="col-span-2 col-start-auto col-end-auto ...">
    <div class="bg-white rounded-xl  transform hover:scale-95 duration-300 border-black border-2 border-b-8">
      ...
      <div class="form-row">
        <div class="form-group col-md-2">
          <input type="number" class="form-control border-black border-2 border-b-4 rounded-lg" id="inputCity" name="a" placeholder="(a)2..">
        </div>
        <div class="form-group col-md-0">
          <h4> + </h4>
        </div>
        <div class="form-group col-md-2">
          <input type="number" class="form-control border-black border-2 border-b-4 rounded-lg" id="inputCity" name="b" placeholder="(b)2..">
        </div>
        <div class="form-group col-md-0">
          <h4> = </h4>
        </div>
