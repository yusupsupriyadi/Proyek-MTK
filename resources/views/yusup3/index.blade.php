...
<div class="container mx-auto px-4 py-4">
    <div class="bg-white rounded-xl border-black border-2 border-b-8">
      <div class="p-5">
        <form action="/yusup3_proses" method="POST">
    @csrf

<h1 class="pb-3 font-bold text-2xl">Menentukan Garis singgung lingkaran yang melalui titik P(x1, y1) pada lingkaran <br> x2 + y2 + Ax + By + C = 0 </h1>
  <div class="form-row">
  ...
  <div class="form-row">
    ...
    <div class="form-group col-md-2">
      <input type="number" class="form-control border-black border-2 border-b-4 rounded-lg" id="inputZip" name="c" placeholder="C" Required>
    </div>
    <h4 class="font-bold text-2xl"> = </h4>
    <h4 class="font-bold text-2xl"> 0 </h4>
  </div>
  <div class="form-group">
