...
<div class="container mx-auto px-4 py-4">
    <div class="bg-white rounded-xl border-black border-2 border-b-8">
      ...
      <h1 class="font-bold text-2xl">Menentukan persamaan lingkaran dengan pusat (0,0) dan Jari-Jari</h1>
      <div class="form-row">
      </div>
      ...
      <div class="form-row">
        <div class="form-group col-md-2">
          <input type="number" class="form-control border-black border-2 border-b-4 rounded-lg" id="inputCity" name="a" placeholder="0" disabled>
        </div>
        <div class="form-group col-md-0">
          <h4> + </h4>
        </div>
        <div class="form-group col-md-2">
          <input type="number" class="form-control border-black border-2 border-b-4 rounded-lg" id="inputCity" name="b" placeholder="0"disabled>
        </div>
        <div class="form-group col-md-0">
          <h4> = </h4>
        </div>
